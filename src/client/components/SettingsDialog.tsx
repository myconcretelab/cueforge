import { CloudDownload, FileArchive, FolderPlus, LogOut, Settings2, X } from 'lucide-react';
...
export function SettingsDialog({ user, projects, selectedProjectId, offlineStatus, onChooseProject, onCreateProject, onImportSoundShow, onCacheOffline, onLogout, onClose }: Props) {
