import { AudioWaveform, Infinity as InfinityIcon, MoreHorizontal, Play } from 'lucide-react';
...
export function TrackPad({ track, color, active, shortcut, onPrimary, onSecondary, onEdit }: Props) {
