...
export function AppUpdateBanner({ playbackActive, onApply }: Props) {
  return <aside className="app-update-banner" role="status" aria-live="polite">
    ...
    <div><strong>Une mise à jour de SonoRiva est prête</strong><small>{playbackActive ? 'La régie joue actuellement. Terminez les lectures avant de l’installer.' : 'Rechargez lorsque vous êtes prêt.'}</small></div>
