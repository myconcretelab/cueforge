...
Le titre initial correspond au nom du fichier sans son extension. Le navigateur mesure la durée du média, puis le fichier et cette durée sont envoyés vers le stockage du compte avant la création de la piste.

## Sélection de fichiers

Une sélection de fichiers peut être déposée sur la fenêtre de SonoRiva. La durée de chaque média est mesurée avant son envoi. Les fichiers sont importés dans la catégorie active et la progression globale est affichée pendant le transfert.
...
L’import recrée les catégories, leurs couleurs, les pistes, les boucles et les points d’entrée et de sortie détectés. Lorsque SoundShow ne fournit pas de durée, celle du fichier local est mesurée avant l’envoi. Les playlists et les séquences SoundShow ne sont pas recréées.
